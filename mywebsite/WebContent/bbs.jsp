<%@page import="javax.security.auth.callback.ConfirmationCallback"%>
	...
	<body>
		...
		<%
			...
			MyUtil.logMessage(this, "바디개행");

			//로긴한사람이라면	 userID라는 변수에 해당 아이디가 담기고 그렇지 않으면 null값

			String userID = null;
			MyUtil.logMessage(this, "비로그인 회원");

			if (session.getAttribute("userID") != null) {

				userID = (String) session.getAttribute("userID");
				MyUtil.logMessage(this, "로그인 회원");
	

			}

			MyUtil.logMessage(this, "유저ID = " + userID);
			...
			MyUtil.logMessage(this, "페이지 넘버  = " + pageNumber);
		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					--%>
					<li class="active"><a href="bbs.jsp">예제</a></li>
				...
				<table class="table table-striped"
					...
					<tbody>
						...
						<%
							...
							ArrayList<Bbs> list = bbsDAO.getList(pageNumber);		// 게시판의 각 페이지를 담는 리스트
							
							MyUtil.logMessage(this, "받아온 리스트");
